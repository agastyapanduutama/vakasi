...
echo form_open(base_url('admin/nilai/add'), 'class="form-horizontal"');;
?>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
                <input type="text" name="nama_nilai" class="form-control" required>
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-2 control-label">Kode Nilai</label>
            <div class="col-md-5">
                <input type="text" name="kode_nilai" class="form-control" required>
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-2 control-label">Harga</label>
            <div class="col-md-5">
                <input type="text" name="harga_nilai" class="form-control" required>
            </div>
        </div>
